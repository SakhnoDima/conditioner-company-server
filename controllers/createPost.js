...
const API_TOKEN = '9589fcc5c3365f96a330d763a34d7b908b95c22760a0ae9b24a70d94e6bd34d3'
...
const testLocations = [
    {
        ...
        "fieldData": {
            ...
            "rating": 4.3,
            "totalreviews": 11,
            "reviewslink": "https://www.google.com/maps/place/?q=place_id:ChIJq6qa5GZnzEwR2nYzIT6nEak",
            "image1": "",
            "image2": "",
            "image3": "",
            "image4": "",
            ...
            "saturday": "Closed",
            "sunday": "Closed",
            "sitelink": "https://www.aeonheating.com/?utm_source=https://www.klimaanlagenfinder.de&utm_medium=website&utm_campaign=general",
...
async function createWebflowPost(places) {
    const url = 'https://api.webflow.com/v2/collections/675fee9ed66623e9cfb33744/items';
...
createWebflowPost(testLocations)

async function publishCollectionItem() {
    console.log('itemsId ', itemsId)
    const url = 'https://api.webflow.com/v2/collections/6759955cc6851d70d6b59469/items/publish ';
    ...
    try {
        ...
        console.error('Error publish post:', error.response ? error.response.data : error.message);
    }
}
...
module.exports = {createWebflowPost}
